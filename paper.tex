...
the generator.The gradients for backpropagation have vanished. This was seen in training. The generator suffered from mode collapse and made more samples with more similarity between them.
...
The increasingly small differences between the observed $D_{KL}(t||g)$ and $D_{KL}(g||t)$ values with respect to the values throughout training is important. This suggests that the training and generated distributions $t$ and $g$ are suited for replacement with each other, as opposed to a preferred replacement of one with the other.
...
\begin{figure*}[hbt!]
\includegraphics[width=17cm]{figures/graphs/kl_trials_all.png}
\centering
...
\begin{table*}[t]
  ...
  \begin{tabular}{ccccccc}
    \hline\hline
    & $(t||g)$  $(g||t)$ & $(t||u)$ $(u||t)$ & $(g||u)$ $(u||g)$ & $(t||t)$  $(t||t)$ & $(g||g)$  $(g||g)$ & $(u||u)$  $(u||u)$\\ [1ex]
    \hline\hline
    $k=1$ & 0.358 0.344 &  0.619 0.531 & 0.804 0.722 & 0.195 0.195 & 0.196 0.196 & 0.203 0.202  \\ 
    % \hline
    $k=2$ & 0.322 0.309 & 13.879 1.517 & 13.904 1.628 & 0.199 0.199 & 0.202 0.202 & 0.355 0.370 \\
    % \hline
    $k=4$ & 0.309 0.292 & 38.687 2.318 & 38.953 2.438 & 0.196 0.195 & 0.197 0.197 & 0.178 0.180 \\ [1ex]
    \hline\hline
  \end{tabular}
  \caption{Results from the $D_{KL}$ trials averaged over redshift $z$ for each kernel size $k$ for each distribution comparison.}
  \label{tab:1}
\end{table*}
...
% \centering
% \begin{tabularx}
% {\columnwidth}{@{}l *5{>{\centering\arraybackslash}X}@{}}%{||c c c c c c||} 
%  \hline
%   $(t||g)$  $(g||t)$ & $(t||g)$  $(g||t)$ & $(t||g)$  $(g||t)$ 
%   $(t||g)$  $(g||t)$ & $(t||g)$  $(g||t)$ & $(t||g)$  $(g||t)$\\ [0.5ex]
%     % $D_{KL}(t||g)$  $D_{KL}(g||t)$ & $D_{KL}(t||g)$  $D_{KL}(g||t)$ & $D_{KL}(t||g)$  $D_{KL}(g||t)$ 
% %   $D_{KL}(t||g)$  $D_{KL}(g||t)$ & $D_{KL}(t||g)$  $D_{KL}(g||t)$ & $D_{KL}(t||g)$  $D_{KL}(g||t)$
%  \hline\hline
%  0.358 0.344 &  0.619 0.531 & 0.804 0.722 & 0.195 0.195 & 0.196 0.196 & 0.203 0.202  \\ 
%  0.322 0.309 & 13.879 1.517 & 13.904 1.628 & 0.199 0.199 & 0.202 0.202 & 0.355 0.370 \\
%  0.309 0.292 & 38.687 2.318 & 38.953 2.438 & 0.196 0.195 & 0.197 0.197 & 0.178 0.180 \\ [1ex]
% \hline
% \end{tabularx}
...
Conv3D  & - & $(32, 32, 32, 1)$ \\ 
 ...
 \hline
 Conv3D & - & $(32, 32, 32, 32)$ \\
  ($7\times7\times7$)&   ELU &  strides=1 \\
 \hline
  Conv3D & BatchNorm & $(16, 16, 16, 32)$ \\
  ($7\times7\times7$) &   ELU &  strides=2 \\
 \hline
