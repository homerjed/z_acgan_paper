...
\twocolumn[
	\begin{@twocolumnfalse}
		...
		\begin{abstract}
		    ...
		    Adversarial Network to create realistic samples of cosmological structure at various values of redshift~$z$. Provisional samples of the virtual cosmic web are obtained from N-body simulation data that is restricted to 
		    ...
		    are also outlined. 
		  %  The most pertinent application being for a generator that can produce samples that maintain high statistical coherence to simulation data at various redshifts. 
